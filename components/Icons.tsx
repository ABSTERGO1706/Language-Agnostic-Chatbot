...
export const UploadIcon: React.FC<IconProps> = (props) => (
    // Fix: Corrected a typo in the viewBox attribute. Was "0 0 24" 24", is now "0 0 24 24".
...
export const MessageSquarePlusIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v2"/><line x1="12" x2="12" y1="7" y2="13"/><line x1="9" x2="15" y1="10" y2="10"/></svg>
);
...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M20.94 11.041c0-0.783-0.07-1.54-0.203-2.281H12v4.31h4.98c-0.21 1.39-0.853 2.584-1.82 3.38v2.809h3.61c2.112-1.944 3.33-4.814 3.33-8.218z" fill="#4285F4"/>
        <path d="M12 21c2.61 0 4.8-0.867 6.4-2.34l-3.61-2.809c-0.87.587-1.98.93-3.15.93-2.39 0-4.42-1.61-5.14-3.78H4.9v2.89C6.6 19.134 9.11 21 12 21z" fill="#34A853"/>
        <path d="M6.86 12.71c-0.23-0.69-0.23-1.43 0-2.12V7.71H4.9C4.1 9.274 4.1 11.026 4.9 12.59l1.96-1.55v-1.33z" fill="#FBBC05"/>
        <path d="M12 6.58c1.34 0 2.49.46 3.42 1.35l3.04-3.04C16.8 3.29 14.6 2 12 2 9.11 2 6.6 3.866 4.9 6.29l3.74 2.89c0.72-2.17 2.75-3.6 5.14-3.6z" fill="#EA4335"/>
    </svg>
);
